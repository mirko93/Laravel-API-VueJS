...
<div class="mx-auto h-full flex justify-center items-center bg-gray-300">
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
        ...
        <h2 class="text-blue-400">Enter your information below</h2>
        ...
        <form method="POST" action="{{ route('register') }}" class="pt-8">
            ...
            <div class="relative">
                ...
                <div>
                    <input id="name" type="text" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="name" value="{{ old('name') }}" autocomplete="name" required autofocus placeholder="Your Name">
            ...
            <div class="relative pt-3">
                ...
                <div>
                    <input id="email" type="email" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="email" value="{{ old('email') }}" autocomplete="email" required placeholder="your@email.com">
            ...
            <div class="relative pt-3">
                ...
                <div>
                    <input id="password" type="password" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="password" autocomplete="new-password" required placeholder="Password">
            ...
            <div class="relative pt-3">
                ...
                <div>
                    <input id="password-confirm" type="password" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="password_confirmation" autocomplete="new-password" required placeholder="Confirm Password">
                </div>
            </div>
