        ...
        <div class="flex">
            <div class="pl-6 bg-gray-200 w-48 h-screen border-r-2 border-gray-400">
                <nav class="pt-4">
                    ...
                    <p class="text-gray-500 uppercase font-bold text-xs pt-12">Create</p>
                    ...
                    <p class="text-gray-500 uppercase font-bold text-xs pt-12 ">General</p>

                    <router-link to="/contacts" class="flex items-center py-2 hover:text-blue-400 text-sm">
                    ...
                    <router-link to="/birthdays" class="flex items-center py-2 hover:text-blue-400 text-sm">
                    ...
                    <p class="text-gray-500 uppercase font-bold text-xs pt-12 ">Settings</p>

                    <router-link to="/logout" class="flex items-center py-2 hover:text-blue-400 text-sm">
...
export default {
    ...
    watch: {
        ...
        title() {
            document.title = this.title + ' | Jot App'
        }
    }
}
</script>
